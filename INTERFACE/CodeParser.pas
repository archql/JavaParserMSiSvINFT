...
//            end;
    ...
    var comment, finish, ignoreBracket: boolean;
        ...
        begin
            ...
            ShowMessage('WoopS! An error occured while parsing primary code! '#13#10'Error msg: ' + ERRORMSG[err]+ ' at lexem #'+ inttostr(nLexems) +', '#13#10'caused by '+ lexems[nLexems-1]);
            finish := true;
        end;
